...
public class ChatServiceTest {
    ...
    public void test_handleMessage_01() {
        List<String> message = chatService.handleMessage("100003", "cgh", "你具备哪些能力");
    ...
    public void test_handleMessage_04_withImage() throws IOException {
        ...
        ChatCommandEntity chatCommandEntity = ChatCommandEntity.builder()
                ...
                .files(List.of())
                .inlineDataList(List.of(new ChatCommandEntity.Content.InlineData(imageResource.getContentAsByteArray(), MimeTypeUtils.IMAGE_PNG_VALUE)))
                .build();
