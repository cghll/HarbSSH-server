...
public class AiAgentAutoConfigTest {
    ...
    public void test_agent() throws InterruptedException {
        ...
        Flowable<Event> events = runner.runAsync("cgh", session.id(), userMsg);
    ...
    @Test
    public void test_handlerMessage_07(){
        ...
        Content userMsg = Content.fromParts(Part.fromText("把cghandherry转换为大写"));
        Flowable<Event> events = runner.runAsync("cgh", session.id(), userMsg);
