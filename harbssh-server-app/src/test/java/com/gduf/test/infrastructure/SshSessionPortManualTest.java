package com.gduf.test.infrastructure;


import com.gduf.infrastructure.adapter.port.SshSessionPort;
...
public class SshSessionPortManualTest {
    ...
    /**
     * 这个里的IP、账号要换成你自己的云服务器；<a href="8.138.236.105/">http://8.138.236.105/</a>
     */
    private static final String HOST = "8.138.236.105";
