...
CREATE database if NOT EXISTS `harbssh` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
use `harbssh`;
...
# 转储表 ssh_connection_config,高级配置
# ------------------------------------------------------------
