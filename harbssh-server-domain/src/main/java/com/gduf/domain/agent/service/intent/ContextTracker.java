...
import com.gduf.domain.agent.model.valobj.intent.IntentHistoryEntryVO;
...
public class ContextTracker {
     ...
     * 获取会话的连续失败次数。
     * <p>
     * 供 {@link com.gduf.domain.agent.service.intent.IntentService} 在 classify
     ...
     * {@link com.gduf.domain.agent.model.valobj.intent.IntentTypeEnumVO#CONTINUE}。
     *
     * @param sessionId 会话 ID
