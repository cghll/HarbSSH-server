package com.gduf.domain.agent.service.intent.classifier.impl;
...
import com.gduf.domain.agent.model.valobj.intent.IntentRuleVO;
import com.gduf.domain.agent.model.valobj.intent.IntentTypeEnumVO;
import com.gduf.domain.agent.service.intent.classifier.IIntentClassifier;
...
public class RuleIntentClassifier implements IIntentClassifier {
    ...
    public IntentResultVO classify(String message, ConversationContextVO context) {
        ...
        for (IntentRuleVO rule : RULES) {
            ...
            // 只要任意一个正则能匹配到 message 文本，就返回 true
