package com.gduf.domain.agent.service.memory;

import com.gduf.domain.agent.adapter.repository.IChatHistoryRepository;
import com.gduf.domain.agent.adapter.repository.ILongTermMemoryRepository;
import com.gduf.domain.agent.model.entity.ChatMessageEntity;
import com.gduf.domain.agent.model.entity.LongTermMemoryEntity;
...
public class LongTermMemoryService implements ILongTermMemoryService {
    ...
    public void recordAssistantConclusion(String userId, String sessionId, String assistantContent) {
        ...
        if (!(normalized.contains("结论") || normalized.contains("原因") || normalized.contains("建议") ||
                normalized.contains("修复") || normalized.contains("根因"))) {
            return;
        }
