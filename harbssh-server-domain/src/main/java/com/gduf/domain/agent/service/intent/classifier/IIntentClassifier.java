package com.gduf.domain.agent.service.intent.classifier;
...
public interface IIntentClassifier {
     ...
     * {@link IntentTypeEnumVO#UNKNOWN}（confidence=0），由上层 {@link cn.bugstack.ai.domain.agent.service.intent.IntentService}
     * 统一决策是否交给主模型处理。
     *
